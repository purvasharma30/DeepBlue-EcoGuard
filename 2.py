...
import pandas as pd
test_df = pd.read_csv('/Users/chiya/Downloads/Underwater-Waste-Detection-Using-YoloV8-And-Water-Quality-Assessment-main/test_data/test_df.csv')
...
def app2():
    ...
    model = load_model('/Users/chiya/Downloads/Underwater-Waste-Detection-Using-YoloV8-And-Water-Quality-Assessment-main/models/Water_Potability/xgboost_without_source_month')
